...
class ApiException implements Exception {
  ...
  /// True bila konflik state / duplikasi (409) — mis. pesanan sudah diambil.
  bool get isConflict =>
      httpStatus == 409 || code == 'INVALID_STATUS' || code == 'CONFLICT';

  bool get isUnauthenticated => httpStatus == 401 || code == 'UNAUTHENTICATED';
